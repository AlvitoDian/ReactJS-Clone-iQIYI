...
const PopularMovieCard = () => {
    ...
    return (
        <div className="bg-[#111319] h-screen xxl:pl-12 xl:px-12 lg:px-7 md:px-3 sm:px-3 ">
            <div className="absolute z-20 xxl:-mt-28 xl:-mt-28 transition-all duration-300 ">
                <div className="flex flex-col ">
                    ...
                    {/* Cards Loop */}
                    <div className="slider-container w-[95vw] sm:w-[98vw] md:w-[98vw] -ml-2 xxl:-ml-2 xl:-ml-2 z-20 hover:z-[200]">
                        <Slider
                            ref={sliderRef}
                            {...settings}
                            className="mr-5 "
                        ...
                        >
                            {movies.map((movie) => (
                                <a
                                    key={movie.id}
                                    href="/"
                                    className="flex flex-col mr-3 w-[210px] md:w-[150px] sm:w-[121px] h-auto transition-all duration-300 mb-4 relative py-10 z-10 hover:z-50"
                                    onMouseEnter={() => {
